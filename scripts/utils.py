...
def get_save_task_dir(task_dir: str, save_dir: str, lite: bool = False) -> str:
    ...
    save_dir = os.path.join(save_dir, rel_path)
    if lite:
        save_dir = save_dir.replace("mlebench", "mlebench_lite")
    return save_dir
...
def get_csv(path: str, file_name: str):
