...
TOKEN_COSTS = {
    ...
    "meta-llama/llama-4-maverick-17b-128e-instruct": {"prompt": 0.0002, "completion": 0.0006}, # For groq
    ...
    "deepseek-chat": {"prompt": 0.00056, "completion": 0.00168},  # In deepseek official website, use deepseekV3.1-terminus
...
def count_message_tokens(messages, model="gpt-3.5-turbo-0125"):
    ...
    if model in {
        ...
        try:
            ...
            logger.warning(f"Could not get encoding for Llama model {model}, using cl100k_base")
            encoding = tiktoken.get_encoding("cl100k_base")
    else:
