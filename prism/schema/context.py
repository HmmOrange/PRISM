...
from prism.settings import cost_manager, token_cost_manager, fireworks_cost_manager
...
class Context(BaseModel):
    ...
    def embedding_with_cost_manager_from_embedding_config(self, embedding_config: EmbeddingConfig) -> BaseEmbedding:
