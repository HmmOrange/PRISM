...
class Plan(BaseModel):
    ...
    def append_task(
        self, task_id: str, dependent_task_ids: list[str], instruction: str, assignee: str, task_type: str = "", expected_output: str = ""
    ):
        """
    ...
    def replace_task(self, task_id: str, new_dependent_task_ids: list[str], new_instruction: str, new_assignee: str, task_type: str, expected_output: str):
