...
from prism.utils.serialize import (
...
class Message(BaseModel):
    ...
    def check_cause_by(cls, cause_by: Any) -> str:
        return any_to_str(
            cause_by
            if cause_by
            else import_class("UserRequirement", "prism.actions.user_requirement")
        )
    ...
    def __str__(self):
        ...
        if self.instruct_content:
            return str({"role": self.role, "content": self.instruct_content.model_dump()})
